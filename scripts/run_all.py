...
def main() -> None:
    ...
    run_step(
        "Step 1/4: Generating sample dataset (periodic_emitters)",
        [
            py,
            "scripts/generate_dataset.py",
            "--config",
            "configs/scenarios/periodic_emitters.yaml",
            "--receiver",
            args.receiver,
            "--seed",
            str(args.seed),
    ...
    run_step(
        "Step 2/4: Running full benchmark (all schedulers × all scenarios × 5 seeds)",
        [
            py,
    ...
    run_step(
        "Step 3/4: Evaluating and printing summary table",
        [
            py,
            "scripts/evaluate.py",
            "--results-dir",
