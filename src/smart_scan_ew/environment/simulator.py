...
class Simulator:
    ...
    def __init__(
        ...
        self._rng = np.random.default_rng(seed if seed is not None else scenario_cfg.seed)
    ...
    def step(self, action: Action) -> Observation:
        ...
        * Episode must not be done.
        ...
        occupied = False
        best_power_dbm: float | None = None
    ...
    def _advance_truth_log(self, start: int, end: int, band_id: int | None) -> None:
