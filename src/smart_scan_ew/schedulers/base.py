...
class BaseScheduler(ABC):
    ...
    def __init__(self, receiver_cfg: ReceiverConfig, seed: int = 0) -> None:
        ...
        self._enabled_bands: list[int] = [
            b.band_id for b in receiver_cfg.bands if b.enabled
        ]
    ...
    def select_action(
        self, belief: BeliefState, last_obs: Observation | None = None
    ) -> Action:
    ...
    @abstractmethod
    def _select_action(
        self, belief: BeliefState, last_obs: Observation | None
    ) -> Action:
