...
class TestSimulatorBasics:
    ...
    def test_different_seeds_different_results(self, empty_scenario, receiver_cfg):
        ...
        energies1 = [
            sim1.step(Action(band_id=0, dwell_slots=1)).energy_statistic for _ in range(20)
        ]
        energies2 = [
            sim2.step(Action(band_id=0, dwell_slots=1)).energy_statistic for _ in range(20)
        ]
